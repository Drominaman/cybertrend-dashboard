...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75c-4.828 0-8.25-3.422-8.25-7.75S7.172 6.25 12 6.25s8.25 3.422 8.25 7.75S16.828 21.75 12 21.75z" />
    </svg>
);
...
export const PresentationChartLineIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.75v6.75" />
